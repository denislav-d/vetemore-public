...
const brands = [
  { id: 1, name: "1017 ALYX 9SM", logo: alyx_logo },
  { id: 2, name: "A-COLD-WALL*", logo: acw_logo },
  {
    id: 3,
  ...
  { id: 4, name: "Balenciaga", logo: balenciaga_logo },
  {
    id: 5,
    name: "Givenchy",
    logo: givenchy_logo,
  ...
  { id: 6, name: "Jacquemus", logo: jacquemus_logo },
  { id: 7, name: "Maison Margiela", logo: margiela_logo },
  { id: 8, name: "Raf Simons", logo: raf_logo },
  { id: 9, name: "Rick Owens", logo: rick_logo },
  { id: 10, name: "Vetements", logo: vetements_logo },
];
